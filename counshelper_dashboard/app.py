...
# 실행 환경: Colab 테스트 + Streamlit Cloud 배포 공용
# 프로젝트: 심리상담사를 위한 AI 기반 상담 기록 분석 및 보고서 자동화 플랫폼
# =========================================================
...
"""
    ...
    d2.button(
        ".pdf 다운로드",
        key="report_pdf_download_disabled",
        use_container_width=True,
        disabled=True,
    )
    ...
    d3.button(
        ".docx 다운로드",
        key="report_docx_download_disabled",
        use_container_width=True,
        disabled=True,
    )
